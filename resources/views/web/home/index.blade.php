        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <a class="main-button icon-button" href="#">@lang('web.getStartedBot')</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="section-header text-center">
                <h2>@lang('web.popularExameTitle')</h2>
                <p class="lead">@lang('web.popularExameDesc')</p>
            </div>
        </div>
        <!-- /row -->
        ...
        <div class="row">
            <div class="center-btn">
                <a class="main-button icon-button" href="#">@lang('web.moreExamBot')</a>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8 col-md-offset-2 text-center">
                ...
                <a class="main-button icon-button" href="contact.html">@lang('web.ContactBot')</a>
            </div>
